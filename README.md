...
In order to verify it wotked, the first thing you're going to do it put in this command: `sudo dmesg | grep VT-d` for Intel, and `sudo dmesg | grep AMD-Vi` for AMD. If you were successful, you should see ```[    0.292288] pci 0000:00:00.2: AMD-Vi: IOMMU performance counters supported
...
[    0.613744] AMD-Vi: AMD IOMMUv2 loaded and initialized``` for AMD.
